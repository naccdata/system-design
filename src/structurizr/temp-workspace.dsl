workspace {
    model {
        ...
        enterprise "NACC" {
            ...
            dataRepostorySystem = softwareSystem "NACC Data Repository" "Allows acquisition, management and queries of data sets" {
                ...
                formValidator = container "Data Validator" "API for validation of forms data" {
                ...
                formPipeline = container "Form Pipeline" "Receives and validates forms" {
                    validatedProject = component "Validated Form Store" "Stores validated forms ready for transfer into data warehouse" "REDCap"
                    ...
                    formQuarantine = component "Form Quarantine" "Accepts form submissions" "REDCap" {
                        -> transferService
                    }
                }
                ...
                submissionSystem = container "Submission System" "Supports submission of data" {
                    errorLogs = component "Error Database" "Stores errors for currently quarantined data"
                    archivalStore = component "Archival Storage" "Stores original submissions of data that has been moved out of quarantine"
        ...
        adrcDataSystem = softwareSystem "ADRC Data System" "Data system of ADRC" "External System" {
            -> formQuarantine "Submit forms data" "JSON/HTTPS"
    ...
    views {
        ...
        component formValidator "ValidatorComponent" {
            include *
            autoLayout
        }
